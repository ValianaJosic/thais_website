...
function Home() {
  ...
  <div className={classes.Container} >
    ...
    <div class="icon-bar">
      <a href="https://www.facebook.com/Thais-Reyes-357850721490279/"  target="_blank" rel="noopener" class="facebook"><i class="fa fa-facebook"></i></a>
      <a href="https://twitter.com/thaisreyes" target="_blank" rel="noopener" class="twitter"><i class="fa fa-twitter"></i></a>
      <a href="https://www.linkedin.com/in/thais-reyes-%F0%9F%8F%96-43474526" target="_blank" rel="noopener" class="linkedin"><i class="fa fa-linkedin"></i></a>
  </div>
